...
pub use queries::{
    ...
    privilege_escalation_paths, resolve_contexts, resolve_org_context, risky_instance_profiles,
    snapshot_account_id, stitch_cross_account, who_can, AccountRecord, EntityRef, EscalationPath,
    Hop, OrgEscalationPath, OrgHop, OrgQueryContext, PermissionDiff, PermissionRecord,
    PermissionRow, QueryContext, RiskyInstanceProfile, ScopeSelector, SnapshotRecord,
