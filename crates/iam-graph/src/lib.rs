...
pub use queries::{
    ...
    privilege_escalation_paths, resolve_org_context, resolve_scopes, risky_instance_profiles,
    snapshot_account_id, snapshot_record, snapshots_for_org_run, stitch_cross_account, who_can,
    AccountRecord, Caveat, CaveatCode, EntityRef, EscalationPath, Hop, OrgEscalationPath, OrgHop,
    OrgQueryContext, PermissionDiff, PermissionRecord, PermissionRow, QueryContext, ResolvedScope,
    RiskyInstanceProfile, ScopeSelector, SnapshotRecord, DEFAULT_MAX_HOPS, MAX_HOPS_CAP,
};
