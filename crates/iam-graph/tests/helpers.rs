...
pub fn data_with_user_group_and_inline(account_id: &str) -> CollectedData {
    ...
    let carol = IamUser {
        ...
        access_keys: vec![
            iam_models::AccessKeyMeta {
                access_key_id: "AKIACAROLACTIVE".to_string(),
                status: iam_models::AccessKeyStatus::Active,
                create_date: Utc::now(),
                last_used_date: None,
            ...
            iam_models::AccessKeyMeta {
                access_key_id: "AKIACAROLINACTIVE".to_string(),
                status: iam_models::AccessKeyStatus::Inactive,
                create_date: Utc::now(),
                last_used_date: None,
                last_used_service: None,
                last_used_region: None,
